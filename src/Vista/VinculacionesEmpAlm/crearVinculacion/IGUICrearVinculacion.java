package Vista.VinculacionesEmpAlm.crearVinculacion;
...
public class IGUICrearVinculacion extends JFrame implements IGUI{
	
	
	public IGUICrearVinculacion(){
		JPanel main = new JPanel(new GridLayout(3, 2));
		this.setContentPane(main);
		this.setTitle("Crear Vinculacion Empleado-Almacen");
		...
		ok.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				try{
					...
					Controlador.getInstancia().accion(Evento.CREAR_VINCULACION, tv);
					dispose();
