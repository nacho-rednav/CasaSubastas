...
public class IGUI_ID_listarPorEmpleado extends JFrame implements IGUI{
	
	public IGUI_ID_listarPorEmpleado(){
		...
		ok.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				try{
					...
					tt.setId_Empleado(emp);
					Controlador.getInstancia().accion(Evento.LISTAR_ESPECIALIDAD_EMPLEADO, tt);
					dispose();
